...
urlpatterns = [
    ...
    # 我的收藏
    path('my-bookmarks/', my_bookmarks, name='my-bookmarks'),
    ...
    path('notifications/<int:notification_id>/read/', NotificationViewSet.as_view({'post': 'mark_read'}), name='mark-notification-read'),
] 