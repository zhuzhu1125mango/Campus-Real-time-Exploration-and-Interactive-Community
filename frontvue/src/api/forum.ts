...
export const forumApi = {
  ...
  markNotificationAsRead(notificationId: number): Promise<void> {
    return request.post(`/api/notifications/${notificationId}/mark_read/`)
  },

  markAllNotificationsAsRead(): Promise<void> {
    return request.post('/api/notifications/mark_all_read/')
  },
  ...
  unbookmarkTopic(topicId: number): Promise<void> {
    return request.post(`/api/topics/${topicId}/unbookmark/`)
  },
  ...
  unlikePost(postId: number): Promise<void> {
    return request.delete(`/api/posts/${postId}/unlike/`)
  },
