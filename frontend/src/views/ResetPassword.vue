<template>
  <div class="reset-container">
    <div class="reset-card">
      ...
      <!-- 手机验证码重置 -->
      <form v-if="activeTab === 'phone'" @submit.prevent="handlePhoneReset" class="reset-form">
        ...
        <div class="form-group">
          <label for="phonePassword">新密码</label>
          <div class="input-wrapper">
            ...
            >
              <span :class="['toggle-password-icon', showPhonePassword ? 'show' : 'hide']"></span>
            </button>
          </div>
        </div>
        
        <div class="form-group">
          <label for="phonePasswordConfirm">确认密码</label>
          <div class="input-wrapper">
            <span class="input-icon password-icon"></span>
            <input
              :type="showPhonePasswordConfirm ? 'text' : 'password'"
            ...
            <button 
              type="button" 
              class="btn-toggle-password" 
              @click="showPhonePasswordConfirm = !showPhonePasswordConfirm"
            >
              <span :class="['toggle-password-icon', showPhonePasswordConfirm ? 'show' : 'hide']"></span>
            </button>
          </div>
        </div>
      ...
      <!-- 邮箱验证码重置 -->
      <form v-if="activeTab === 'email'" @submit.prevent="handleEmailReset" class="reset-form">
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="emailPassword">新密码</label>
          <div class="input-wrapper">
            <span class="input-icon password-icon"></span>
            <input
            ...
            >
              <span :class="['toggle-password-icon', showEmailPassword ? 'show' : 'hide']"></span>
            </button>
          </div>
        </div>
        
        <div class="form-group">
          <label for="emailPasswordConfirm">确认密码</label>
          <div class="input-wrapper">
            <span class="input-icon password-icon"></span>
            <input
              :type="showEmailPasswordConfirm ? 'text' : 'password'"
            ...
            <button 
              type="button" 
              class="btn-toggle-password" 
              @click="showEmailPasswordConfirm = !showEmailPasswordConfirm"
            >
              <span :class="['toggle-password-icon', showEmailPasswordConfirm ? 'show' : 'hide']"></span>
            </button>
          </div>
        </div>
...
const handlePhoneReset = async () => {
  ...
  try {
    ...
    showToast(getErrorMessage(error, '密码重置失败，请检查信息是否正确'), 'error')
  } finally {
    loading.value = false
  }
}
